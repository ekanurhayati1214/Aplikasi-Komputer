...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-005.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-013.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-017.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-019.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-021.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-022.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-030.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-034.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-042.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-043.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-044.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-045.png}
\begin{eulercomment}
Clear the data.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulercomment}
\begin{eulercomment}
\eulerheading{Pengantar Untuk Pengguna R Project}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Operator "\textless{}-" untuk penugasan juga menyesatkan, dan bukan ide yang
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-048.png}
\eulerheading{Lists/Daftar}
\begin{eulercomment}
...
\begin{eulercomment}
\begin{eulercomment}
\eulerheading{File Input and Output (Membaca and Menulis Data)}
\begin{eulercomment}
...
Semua koma digantikan oleh titik-titik dengan parameter \textgreater{}coma. Untuk
...
\end{eulerprompt}
\eulerimg{16}{images/EMT4Statistika_Eka Nurhayati_22305141016-049.png}
\begin{eulercomment}
...
>readversion
\end{eulerprompt}
\eulerheading{Input and Output Variabel}
\begin{eulercomment}
