...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-004.png}
...
>Q=[5,6]; plotPoint(Q,"Q"):
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-005.png}
\begin{eulerprompt}
>plotSegment(O,P,"q");
>plotSegment(P,Q,"o");
>plotSegment(Q,O,"p");
>lineThrough(O,P):
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-006.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-007.png}
\begin{eulerprompt}
>norm(O-P)*norm(Q-D)/2
\end{eulerprompt}
\begin{euleroutput}
...
\]
\end{eulerformula}
\eulerimg{1}{images/Eka Nurhayati_22305141016_EMT4Geometry-009-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/Eka Nurhayati_22305141016_EMT4Geometry-011-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Eka Nurhayati_22305141016_EMT4Geometry-017-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-021.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-023.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-024.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
\left[ y=\frac{\left({\it P_2}-{\it P_1}\right)_{2}\,x+\left[ -  \left({\it P_2}-{\it P_1}\right)_{2} , \left({\it P_2}-{\it P_1}  \right)_{1} \right] \cdot {\it P_1}}{\left({\it P_2}-{\it P_1}  \right)_{1}} \right] 
\]
\end{eulerformula}
\begin{eulercomment}
Ini memang sama dengan perpendicular tengah, yang dihitung dengan cara
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-033.png}
\begin{eulerprompt}
>remvalue x,y,a,b,c
...
\end{eulerprompt}
\eulerimg{15}{images/Eka Nurhayati_22305141016_EMT4Geometry-037.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/Eka Nurhayati_22305141016_EMT4Geometry-041-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-042.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Eka Nurhayati_22305141016_EMT4Geometry-049-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-051.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
\frac{\sqrt{725-13\,2^{\frac{3}{2}}\,\sqrt{5}\,\sqrt{7}\,\sqrt{11}}  }{\sqrt{5}}
\]
\end{eulerformula}
\begin{eulercomment}
Mari tambahkan ke plot
\end{eulercomment}
\begin{eulerprompt}
>plotPoint(U()); ...
>plotCircle(circleWithCenter(mxmeval("U"),mxmeval("distance(U,C)"))):
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-056.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/Eka Nurhayati_22305141016_EMT4Geometry-060-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-063.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-066.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-068.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-073.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-075.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-077.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Eka Nurhayati_22305141016_EMT4Geometry-080-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Eka Nurhayati_22305141016_EMT4Geometry-083-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-084.png}
\begin{eulercomment}
Tentu saja,
...
\end{eulerformula}
\begin{eulercomment}
Hal ini lebih mudah dihitung daripada sudut. Tetapi Anda kehilangan
...
\]
\end{eulerformula}
\eulerimg{1}{images/Eka Nurhayati_22305141016_EMT4Geometry-092-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-097.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Eka Nurhayati_22305141016_EMT4Geometry-100-large.png}
\eulerimg{0}{images/Eka Nurhayati_22305141016_EMT4Geometry-101-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/Eka Nurhayati_22305141016_EMT4Geometry-108-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/Eka Nurhayati_22305141016_EMT4Geometry-117-large.png}
...
\end{eulerformula}
\begin{eulercomment}
Karena penyebaran sudut negatif adalah sama, aturan tripel spread juga
berlaku, jika
...
\]
\end{eulerformula}
\eulerimg{0}{images/Eka Nurhayati_22305141016_EMT4Geometry-125-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-127.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/Eka Nurhayati_22305141016_EMT4Geometry-129-large.png}
\eulerimg{1}{images/Eka Nurhayati_22305141016_EMT4Geometry-130-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-132.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
di mana a,b,c menunjukkan quadran.
...
\end{eulerformula}
\begin{eulercomment}
Mari kita periksa rumus ini untuk Egyptian values kita.
\end{eulercomment}
\begin{eulerprompt}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-137.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-141.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-142.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-143.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-144.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-145.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-146.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-147.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-148.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-149.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-150.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-151.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-152.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-153.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-154.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
\left[ u=-\frac{a\,\sqrt{a^2+1}}{2} , u=\frac{a\,\sqrt{a^2+1}}{2}   \right] 
\]
\end{eulerformula}
\begin{eulercomment}
Ada dua solusi.
...
>insimg;
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-158.png}
...
>povend();
\end{eulerprompt}
\eulerimg{19}{images/Eka Nurhayati_22305141016_EMT4Geometry-159.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{19}{images/Eka Nurhayati_22305141016_EMT4Geometry-160.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-161.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-162.png}
...
\end{eulerprompt}
\eulerimg{24}{images/Eka Nurhayati_22305141016_EMT4Geometry-163.png}
\begin{eulerprompt}
>function f(x) := x^2+5x+6
>aspect(2), plot2d("f(x)",-10,5):
\end{eulerprompt}
\eulerimg{11}{images/Eka Nurhayati_22305141016_EMT4Geometry-164.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{11}{images/Eka Nurhayati_22305141016_EMT4Geometry-165.png}
\end{eulernotebook}
\end{document}
